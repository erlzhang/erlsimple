...
- 主题后期将会进一步完善，欢迎提出改进建议；

- 未在php7.0环境中进行兼容性测试；

- 不兼容IE10以下浏览器。

- 若评论提交出现问题，请查看wordpress程序是否安装在根目录下面，若不是，打开主题目录的comments-ajax.php，找到第17行，在/wp-load.php前面加上根目录地址。**（comment-ajax为早起外部插件，比较老旧，部分网站会报错，作者近期将重写ajax插件，敬请期待）**
